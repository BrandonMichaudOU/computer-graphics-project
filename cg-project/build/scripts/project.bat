...
set CLASSPATH=%APP_HOME%\lib\cg-project-1.2.1.jar;%APP_HOME%\lib\jogl-all-v2.4.0-rc-20210111.jar;%APP_HOME%\lib\gluegen-rt-v2.4.0-rc-20210111.jar


@rem Execute project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" Project %*
